				...
				<!--graph-->
				<link rel="stylesheet" type="text/css" href="../Public/Adminstrator/css/graph.css">

				<!--//graph-->
				<script type="text/javascript" src="../Public/Adminstrator/js/jquery.flot.js"></script>
				...
				<script>
					...
					<div class="content-mid">
						...
						<div class="col-md-5">
							...
							<link rel="stylesheet" type="text/css" href="../Public/Adminstrator/css/clndr.css">
							<script type="text/javascript" src="../Public/Adminstrator/js/underscore-min.js"></script>
							<script type="text/javascript" src="../Public/Adminstrator/js/moment-2.2.1.js"></script>
							<script type="text/javascript" src="../Public/Adminstrator/js/clndr.js"></script>
							<script type="text/javascript" src="../Public/Adminstrator/js/site.js"></script>
						...
						<div class="col-md-7 mid-content-top">
							<div class="middle-content">
								...
								<div id="owl-demo" class="owl-carousel text-center">
									<div class="item">
										<img class="lazyOwl img-responsive" data-src="../Public/Adminstrator/images/na.jpg" alt="name">
									</div>
									<div class="item">
										<img class="lazyOwl img-responsive" data-src="../Public/Adminstrator/images/na1.jpg" alt="name">
									</div>
									<div class="item">
										<img class="lazyOwl img-responsive" data-src="../Public/Adminstrator/images/na2.jpg" alt="name">
									</div>
									<div class="item">
										<img class="lazyOwl img-responsive" data-src="../Public/Adminstrator/images/na.jpg" alt="name">
									</div>
							...
							<link rel="stylesheet" type="text/css" href="../Public/Adminstrator/css/owl.carousel.css">
							<script type="text/javascript" src="../Public/Adminstrator/js/owl.carousel.js"></script>
							<script>
								$(document).ready(function() {
