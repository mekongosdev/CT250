...
<?php
  ...
  {
      $ma = $_GET["ma"];
      $resultsql = mysql_query("SELECT a.*, b.PublisherName FROM wine a, publisher b
                  WHERE WineId = ".$ma);
     
     while ($rowsql = mysql_fetch_array($resultsql, MYSQL_ASSOC)){
       ...
       <div class="header">
        <div class="container">
         ...
         <div class="cart box_1">
          <a href="?page=cart"><i class="glyphicon glyphicon-shopping-cart"></i> &nbsp;<i class="simpleCart_total"></i> <span class="badge simpleCart_quantity" class="simpleCart_quantity"><?php if((isset($_SESSION['cart'])) && 
          count($_SESSION['cart'])>0) echo count($_SESSION['cart']); else echo 0;?></span>
          </a>
          <!--  <a href="#">
               <div class="total">
